...
export async function proxy(request: NextRequest) {
  ...
  if (!user && pathname !== "/login" && pathname !== "/admin" && !pathname.startsWith("/auth") && !pathname.startsWith("/api/cron") && pathname !== "/privacy" && pathname !== "/sms-terms" && pathname !== "/no-access" && pathname !== "/house") {
